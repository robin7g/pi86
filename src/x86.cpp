...
{
	// The function starts  in a separate thread 
	// and basically operates the processor bus loop
	if (Processor == 88)
	{
		processorLoop8086();
	}
	else if (Processor == 86)
	{
		processorLoop8086();
	}
	else
	{
		printf("Unknown Processor Type %d stopping.\r\n", Processor);
		Stop_Flag = true;
	}
}
